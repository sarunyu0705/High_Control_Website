            ...
            <div class="row mt-4">
                <div class="col-2 text_center padding_top navlogo_res_mobile">
                    ...
                    <ul id="ul_navlist" class="col text_center padding_top">
                        ...
                        <li class="li_navlist"><a class="active" href="Submersible_Pumps.php">ปั๊มจุ่ม <br> (SUBMERSIBLE PUMPS &
                ...
                <div id="padding_img" class="col container padding_top">
                    <img src="image/product_header/Submesible_Pumps.png" class="d-block w-100 " alt="Page_1" width="300px" height="400px">
                    <p class="font_size_main padding"><b> สินค้าประเภท (ปั๊มจุ่ม) AERATOR SUBMERSIBLE PUMPS , EJECTOR
                            SUBMERSIBLE PUMPS</b></p>
                    <div class="row row-cols-2 row-cols-md-4 g-4">
                        <?php
                        $stmt = $conn->query("SELECT * FROM product WHERE  product_type IN  ('Submersible Pumps', 'Areator Pumps', 'Ejector Pumps');");
                        $stmt->execute();
                        ...
                        ?>
                                ...
                                <div class="col">
                                    <div class="card delete_boder" style="width: 25rem;">
                                        <img src="./php/upload/<?php echo $product['img']; ?>" class="card-img-top card-img-top img_res_mobile" alt=". " width="320px" height="250px">
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                <?php
