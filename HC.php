        ...
        <div class="row">
            ...
            <div class="row mt-4">
                ...
                <div id="padding_img" class="col container padding_top">
                    <img src="image/product_header/HC.png" class="d-block w-100 " alt="Page_1">
                    <p class="font_size_main padding"><b> สินค้าและผลิตภัณฑ์แบรนด์ HC PUMP</b></p>
                    <div class="row row-cols-2 row-cols-md-4 g-4">
                        <?php
                        $stmt = $conn->query("SELECT * FROM product WHERE product_brand = 'HC'");
                        $stmt->execute();
