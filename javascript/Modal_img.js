(function ($) {
    $.fn.imagePopup = function (options) {  //  image Popup จะเป็นชื่อปลั๊กอินของเรา option รับค่าจาก app.js
        //settings จะเป็นตัวแปรที่ใช้ในการดึงคุณสมบัติของตัวเลือก
        // นี่คือคุณสมบัติเริ่มต้น
        ...
        return this.each(function () {
            ...
            function setImageProperties() {
                ...
                if (settings.imageCaption.exist == true) {
                    $imageCaption = $('<p class = "center mt-3"></p>');
                    $imageCaption.css({
                        "color": settings.imageCaption.color,
                        "font-size": settings.imageCaption.fontSize,
                        "width": settings.imageCaption.wtd,
                        // "border-style": settings.imageCaption.Border,
                        // "border-color": settings.imageCaption.BorderColor,
                    });
