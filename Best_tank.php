        ...
        <div class="row">
            ...
            <div class="row mt-4">
                ...
                <div id="padding_img" class="col container padding_top">
                    <img src="image/product_header/Best_Tank.png" class="d-block w-100 " alt="Page_1" width="300px" height="400px">
                    <p class="font_size_main padding"><b> สินค้าและผลิตภัณฑ์แบรนด์ BEST TANK</b></p>
                    <!-- <div class="row"> -->
                    <div class="row row-cols-2 row-cols-md-4 g-4">
                        <?php
                        $stmt = $conn->query("SELECT * FROM product WHERE product_brand = 'BEST TANK'");
                        $stmt->execute();
                        ...
                        ?>
                                ...
                                <div class="col">
                                    <div class="card delete_boder" style="width: 25rem;">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title"><?php echo $product['product_type']; ?></h3>
                                            <h5 class="card-title">
                                                <?php
                                                echo "<b>Model :</b>";
                                                echo '&nbsp;&nbsp;';
