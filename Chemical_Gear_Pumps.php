            ...
            <div class="row mt-4">
                <div class="col-2 text_center padding_top navlogo_res_mobile">
                    ...
                    <ul id="ul_navlist" class="col text_center padding_top">
                        ...
                        <li class="li_navlist"><a class="active" href="Chemical&Gear_Pumps.php">ปั๊มสูบเคมีและน้ำมัน<br>(Chemical &
                                Gear pumps)</a>
                        </li>
                ...
                <div id="padding_img" class="col container padding_top">
                    <img src="image/product_header/Chemical & Gear PUMPS.png" class="d-block w-100 " alt="Page_1" width="300px" height="400px">
                    <p class="font_size_main padding"><b> สินค้าประเภท (ปั๊มสูบเคมีและน้ำมัน) Chemical & Gear Pumps</b>
                        <!-- <div class="row"> -->
                    <div class="row row-cols-2 row-cols-md-4 g-4">
                        <?php
                        $stmt = $conn->query("SELECT * FROM product WHERE product_type = 'Chemical & Gear Pumps'");
                        $stmt->execute();
