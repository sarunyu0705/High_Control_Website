            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="Service.php">บริการ</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 float-md-end mb-3 ms-md-3">
                        <div class="left-image">
                            <img src="image/product_logo/Logo_lanscape.png" class="d-block w-100 h-10 img-fluid" alt="" width="450px" height="300px">
                        </div>
                    </div>
                    <div class="col align-self-center">
                        <div class="section-heading">
                            <h4><b>บริษัท&nbsp;ไฮ&ensp;คอนโทรล&nbsp;จำกัด</b></h4>
                            <hr>
                            <p>
                                บริษัท&nbsp;ไฮ&ensp;คอนโทรล จำกัด จำหน่ายสินค้าอุตสาหกรรม และอุปกรณ์ ต่างๆ ติดตั้งปั๊มน้ำ และซ่อมบำรุงระบบน้ำ พร้อมให้คำปรึกษาและบริการหลังการขายโดยช่างและฝ่ายขายผู้มีประสบการณ์ ก่อตั้งบริษัทเมื่อปี พ.ศ. 2559
                                ดำเนินธุรกิจจำหน่ายสินค้าอุตสาหกรรม และอุปกรณ์ ต่างๆ พร้อมบริการออกแบบ ก่อสร้าง ติดตั้ง
                                และซ่อมบำรุงระบบน้ำ ระบบไฟฟ้าแบบครบวงจร โดยทีมช่างที่ชำนาญ
                                <br><br>
                                ประกอบธุรกิจบนพื้นฐานของความซื่อสัตย์สุจริต และเป็นธรรม มุ่งเน้นสินค้าที่มีคุณภาพ
                                และบริการที่เปี่ยมไปด้วยน้ำใจไมตรี ส่งเสริมและพัฒนาทักษะ
                                ความรู้ให้กับบุคลากรเพื่อนำไปสู่กระบวนการทำงานที่มีประสิทธิภาพ
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center mt-4">
                    <div class="col-4">
                        <img src="image/Icons/checkout.png" class="icon_service" alt="" width="60%">
                        <br><br>
                        <p class="font_size_icon"><b> บริการจำหน่ายสินค้า </b></p>
                    </div>

                    <div class="col-4">
                        <img src="image/Icons/repair.png" class="icon_service" alt="" width="60%">
                        <br><br>
                        <p class="font_size_icon"><b> บริการติดตั้งและซ่อมบำรุง </b></p>
                    </div>
                    <div class="col-4">
                        <img src="image/Icons/document.png" class="icon_service" alt="" width="60%">
                        <br><br>
                        <p class="font_size_icon"><b> บริการให้คำปรึกษา </b></p>
                    </div>
                </div>
                <br><br>
                <div class="row">
                    <div class="col">
                        <div class="clearfix ">
                            <img src="image/About/Prouct_office.png" class="col-md-6 float-md-end mb-3 ms-md-3 img-fluid" alt="...">
                            <h4 class=""><b>บริการจำหน่ายสินค้า</b></h4>
                            <hr>
                            <p>
                                ประกอบด้วยสินค้า อาทิ เช่น เครื่องเติมอากาศ โบลเวอร์ แอร์ปั๊ม ปั๊มน้ำระบบน้ำดี-น้ำเสีย ปั๊มน้ำหอยโข่ง ปั๊มจุ่ม
                                ถังแรงดัน ถังเก็บน้ำ ระบบส่งกำลัง มอเตอร์ไฟฟ้า มอเตอร์เกียร์ เกียร์ทดรอบ อินเวอร์เตอร์
                                รอกไฟฟ้า รอกมือสาว อุปกรณ์เครื่องมืออุตสาหกรรม ฯลฯ
                            </p>
                        </div>
                    </div>
                    <div class="clearfix">
                        <img src="image/About/Repair.png" class="col-md-6 float-md-start mb-3 ms-md-3 img-fluid" alt="...">
                        <h4><b>บริการติดตั้งและซ่อมบำรุง</b></h4>
                        <hr>
                        <p>
                            ทางบริษัทให้บริการ ติดตั้งงานระบบต่างๆ ที่เกี่ยวข้องกับปั๊มน้ำ ระบบส่งน้ำ ระบบน้ำบำบัดน้ำดี-น้ำเสีย ติดตั้งตู้ควบคุม
                            อีกทั้งทางเรายังมีบริการซ่อมแซมและเซอร์วิส โดยทีมช่างผู้มีประสบการณ์
                        </p>
                        <!-- <button>คล</button> -->
                    </div>
                    <div class="clearfix">
                        <img src="image/About/Consult.png" class="col-md-6 float-md-end mb-3 ms-md-3 img-fluid" alt="...">
                        <h4><b>บริการให้คำปรึกษา</b></h4>
                        <hr>
                        <p>
                            ทางบริษัทพร้อมให้คำปรึกษา เกี่ยวกับระบบงานปั๊มน้ำ ข้อมูลสินค้า คำปรึกษาและบริการหลังการขายโดยฝ่ายขายผู้มีประสบการณ์มากกว่า 10 ปีเต็ม
                        </p>
                    </div>
                </div>
            </div>
