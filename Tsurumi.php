        ...
        <div class="row">
            ...
            <div class="row mt-4">
                ...
                <div id="padding_img" class="col container padding_top">
                    <img src="image/product_header/Tsurumi.png" class="d-block w-100 card-img-top img_res_mobile" alt="Page_1" width="300px" height="400px">
                    <p class="font_size_main padding"><b> สินค้าและผลิตภัณฑ์แบรนด์ Tsurumi</b></p>
                    <div class="row row-cols-2 row-cols-md-4 g-4">
                        <?php
                        $stmt = $conn->query("SELECT * FROM product WHERE product_brand = 'TSURUMI'");
                        $stmt->execute();
                        ...
                        ?>
                                ...
                                <div class="col">
                                    <div class="card delete_boder" style="width: 25rem;">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title"><?php echo $product['product_type']; ?></h4>
                                            <h5 class="card-title">
                                                <?php
                                                echo "Model :";
                                                echo '&nbsp;&nbsp;';
