        ...
        <div class="row">
            ...
            <div class="row mt-4">
                <div class="col-2 text_center padding_top navlogo_res_mobile">
                    ...
                    <ul id="ul_navlist" class="col text_center padding_top">
                        ...
                        <li class="li_navlist"><a href="Ring&Turbo_Blower.php">เครื่องเติมอากาศ <br> (Ring & Turbo
                                Blower)</a></li>
                        <li class="li_navlist"><a class="active" href="Air_Pump.php">เครื่องเติมอากาศ <br> (Air Pumps)</a></li>
                ...
                <div id="padding_img" class="col container padding_top">
                    <img src="image/product_header/Air_pumps.png" class="d-block w-100 " alt="Page_1" width="300px" height="400px">
                    <p class="font_size_main padding"><b> สินค้าประเภท (เครื่องเติมอากาศ) AIR PUMPS</b></p>
                    <!-- <div class="row"> -->
