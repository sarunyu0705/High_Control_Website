...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        echo "<script>alert('ลบข้อมูลสินค้าเรียบร้อยแล้ว');</script>";
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg_color_nav2">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <a href="logout.php"><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="">ออกจากระบบ</button></a>
                </div>
            </div>
        </nav>
            ...
            <div class="container-fluid">
                <ul class="navbar-nav">
                    <li class="nav-item me-5">
                        <a class="nav-link active" aria-current="page" href="homepage.php">จัดการข้อมูลสินค้า</a>
                    </li>
                    <li class="nav-item me-5">
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist"><a href="../../php/manage_pd/product_fav1.php">รายการโปรด 1 <br> (Favorite 1)</a></li>
                <li class="li_navlist"><a href="../../php/manage_pd/product_fav2.php">รายการโปรด 2 <br> (Favorite 2)</a></li>
                ...
                <li class="li_navlist"><a href="../manage_pd/product_rb.php">เครื่องเติมอากาศ <br> (Roots Blower)</a></li>
                <li class="li_navlist"><a href="../manage_pd/product_r&tb.php">เครื่องเติมอากาศ <br> (Ring & Turbo
                        Blower)</a></li>
                <li class="li_navlist"><a href="../manage_pd/product_ap.php">เครื่องเติมอากาศ <br> (Air Pumps)</a></li>
                <li class="li_navlist"><a href="../manage_pd/product_cp.php">ปั๊มน้ำ <br> (Centrifugal Pumps)</a>
                </li>
                <li class="li_navlist"><a href="../manage_pd/product_cg.php">ปั๊มสูบเคมีและน้ำมัน<br>(Chemical &
                        Gear pumps)</a>
                </li>
                <li class="li_navlist"><a href="../manage_pd/product_sp.php">ปั๊มจุ่ม <br> (SUBMERSIBLE PUMPS &
                        AERATOR PUMPS & EJECTOR PUMPS)</a>
                </li>
                <li class="li_navlist"><a href="../manage_pd/product_pdt.php">ถังแรงดัน <br> (PRESSURE DIAPHARGM TANK)</a>
                </li>
                <li class="li_navlist"><a href="../manage_pd/product_motor.php">มอเตอร์เกียร์ & มอเตอร์ไฟฟ้า<br> (Gear Motors)</a>
                </li>
                <li class="li_navlist"><a href="../manage_pd/product_controlpanel.php">ตู้ควบคุม<br>(Control Panel)</a>
                </li>
            </ul>
        </div>
        <div class="col">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td scope="row">
                                        <p class="text_over_detail"><?= $product['product_detail']; ?></p>
                                    </td>
                                    <td width="250px"><img width="100%" src="../upload/<?= $product['img']; ?>" class="rounded" alt=""></td>
                                    <td>
                                        <a href="../manage_pd/edit_product.php?product_id=<?php echo $product['product_id']; ?>" class="btn btn-warning">แก้ไขข้อมูล</a>
                                        <a onclick="return confirm('แน่ใจใช่ไหมว่าจะทำการลบข้อมูล ?');" href="?delete=<?php echo $product['product_id']; ?>" class="btn btn-danger">ลบข้อมูล</a>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                    ...
                    <form action="../manage_pd/add_product.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select require class="form-select form-control" aria-label="Default select example" name="product_type">
                                ...
                                <option value="Submersible">Submersible (ซับมิสซิเบิ้ล ปั๊ม)</option>
