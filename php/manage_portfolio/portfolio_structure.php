...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url=portfolio_structure.php");
    }
}
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>ผลงานบริษัทประเภท "งานโครงสร้าง"</h2>
            </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist my-2"><a class="active" href="portfolio_structure.php">งานโครงสร้าง</a></li>
                <li class="li_navlist my-2"><a href="portfolio_repair.php">งานซ่อมบำรุง</a></li>
            </ul>
        </div>
        <div class="col">
            <!------------------------------------------ Table Data ------------------------------------------>
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <?php
                            $stmt = $conn->query("SELECT * FROM portfolio WHERE portfolio_type = 'งานโครงสร้าง'");
                            $stmt->execute();
                            ...
                            ?>
                                    ...
                                    <td scope="row"><p class="text_over"><?= $portfolio['portfolio_detail']; ?></p></td>
