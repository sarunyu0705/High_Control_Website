...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url=portfolio_system.php");
    }
}
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>ผลงานบริษัทประเภท "งานระบบ"</h2>
            </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist my-2"><a class="active" href="portfolio_system.php">งานระบบ</a></li>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <?php
                            $stmt = $conn->query("SELECT * FROM portfolio WHERE portfolio_type = 'งานระบบ'");
                            $stmt->execute();
