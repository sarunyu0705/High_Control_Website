...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url=product_ap.php");
    }
}
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>ฐานข้อมูลสินค้า Air Pumps</h2>
            </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist"><a href="product_r&tb.php">เครื่องเติมอากาศ <br> (Ring & Turbo
                        Blower)</a></li>
                <li class="li_navlist"><a class="active" href="product_ap.php">เครื่องเติมอากาศ <br> (Air Pumps)</a></li>
        ...
        <div class="col-10">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $stmt = $conn->query("SELECT * FROM product WHERE product_type = 'Air Pumps'");
                    $stmt->execute();
