...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url= product_pdt.php");
    }
}
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>ฐานข้อมูลสินค้า Pressure Diaphragm Tank</h2>
            </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist"><a class="active" href="product_pdt.php">ถังแรงดัน <br> (PRESSURE DIAPHARGM TANK)</a>
                </li>
        ...
        <div class="col-10">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $stmt = $conn->query("SELECT * FROM product WHERE product_type = 'Pressure Diaphragm Tank'");
                    $stmt->execute();
