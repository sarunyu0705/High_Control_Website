...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url= product_sp.php");
    }
}
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h4>ฐานข้อมูลสินค้า Submersible & Areator & Ejector Pumps</h4>
            </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist"><a href="./product_fav1.php">รายการโปรด 1 <br> (Favorite 1)</a></li>
                <li class="li_navlist"><a href="./product_fav2.php">รายการโปรด 2 <br> (Favorite 2)</a></li>
                <li class="li_navlist"><a href="./product_fav3.php">รายการโปรด 3 <br> (Favorite 3)</a></li>
                ...
                <li class="li_navlist"><a href="product_r&tb.php">เครื่องเติมอากาศ <br> (Ring & Turbo
                        Blower)</a></li>
                <li class="li_navlist"><a href="product_ap.php">เครื่องเติมอากาศ <br> (Ring & Air Pumps)</a></li>
                ...
                <li class="li_navlist"><a class="active" href="product_sp.php">ปั้มจุ่ม <br> (SUBMERSIBLE PUMPS &
