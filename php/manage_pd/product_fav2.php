...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url=product_fav2.php");
    }
}
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>ฐานข้อมูลสินค้ารายการโปรดที่ 2</h2>
            </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-2">
            <ul id="ul_navlist" class="col text_center padding_top">
                ...
                <li class="li_navlist"><a class="active" href="./product_fav2.php">รายการโปรด 2 <br> (Favorite 2)</a></li>
