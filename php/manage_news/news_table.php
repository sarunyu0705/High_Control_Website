...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        echo "<script>alert('ลบข้อมูลกระทู้เรียบร้อยแล้ว);</script>";
        $_SESSION['success'] = "ลบข้อมูลกระทู้เรียบร้อยแล้ว";
        header("refresh:1; url=news_table.php");
    }
}
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-dark bg_color_nav2">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item me-5">
                        <a class="nav-link active" href="../manage_news/news_table.php">จัดการกระทู้ข่าวสาร</a>
                    </li>
                    <li class="nav-item me-5">
    ...
    <div class="container mt-5">
        <div class="row">
            <h2>สามารถแก้ไข เพิ่ม ลบ กระทู้ข่าวสาร</h2>
            <div class="col-md-6">
                <h2>กระทู้ข่าวสารทั้งหมด</h2>
            </div>
            <div class="col-md-6 d-flex justify-content-end">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#userModal">เพิ่มข่าวสารและกระทู้</button>
            </div>
        </div>
        <hr>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="col-3" scope="col">หัวข้อกระทู้</th>
                            <th class="col-2" scope="col">วันที่/เดือน</th>
                            <th class="col-3" scope="col">รายละเอียด</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            ?>
                                    <th scope="row"><?php echo $portfolio['news_id']; ?></th>
                                    <td scope="row"><?= $portfolio['news_name']; ?></td>
                                    <td scope="row"><?= $portfolio['news_date']; ?></td>
                                    <td scope="row">
                                        <p class="text_over"><?= $portfolio['news_detail']; ?></p>
                                    </td>
                                    <!-- <td scope="row"><p class="text_over"><?= $portfolio['news_detail']; ?></p></td> -->
                                    <td width="250px"><img width="120px" height="120px" src="../../image/News/<?= $portfolio['news_img']; ?>" class="rounded" alt=""></td>
                                    <td>
                                        <a href="edit_news.php?news_id=<?php echo $portfolio['news_id']; ?>" class="btn btn-warning m-2">แก้ไข</a>
                                        <a onclick="return confirm('แน่ใจใช่ไหมว่าจะทำการลบข้อมูล ?');" href="?delete=<?php echo $portfolio['news_id']; ?>" class="btn btn-danger m-2">ลบ</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มข่าวสารและกระทู้</h5>
                ...
                <div class="modal-body">
                    <form action="add_news.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" require class="form-control" name="news_name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="my_date_picker" require class="form-control" name="news_date">
                            <script>
                                $(function() {
                        ...
                        <div class="mb-3">
                            <label for="news_img" class="col-form-label">รูปประกอบกระทู้</label>
                            <input type="file" require class="form-control" id="imgInput" name="news_img" multiple>
