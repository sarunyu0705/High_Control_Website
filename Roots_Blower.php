...
<body>
    ...
    <header>
        <nav class="navbar bg_color_nav1 padding testbg">
            ...
            <div class="row mt-4">
                <div class="col-2 text_center padding_top navlogo_res_mobile">
                    ...
                    <ul id="ul_navlist" class="col text_center padding_top">
                        <li class="li_navlist"><a class="active" href="Roots_Blower.php">เครื่องเติมอากาศ <br> (Roots
                                Blower)</a></li>
                ...
                <div id="padding_img" class="col container padding_top ">
                    <img src="image/product_header/Roots_Blower.png" class="d-block w-100 h-10 img-fluid img_res_mobile" alt="Page_1" width="300px" height="400px">
                    <p class="font_size_main padding"><b> สินค้าประเภท (เครื่องเติมอากาศ) ROOTS BLOWER</b></p>
                    <!-- <div class="row"> -->
